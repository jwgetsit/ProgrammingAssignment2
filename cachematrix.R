...
# cacheSolvecalculates the inverse of the special "vector" created with the above function.
#However, it first checks to see if the inverse has already been calculated and that the
#matrix has not changed. If so, it gets the inverse from the cache and skips the computation. Otherwise
#it calculates the inverse of the data and sets the value of the matrix and the inverse in the cache.
